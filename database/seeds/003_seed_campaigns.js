...
exports.seed = async function(knex) {
  ...
  await knex('campaigns').insert([
    ...
    // Programmatic DSP campaigns (TTD, DV360, Amazon DSP)
    {
      id: 'camp-ttd-aiaudio-001',
      projectId: 'proj-seed-001',
      platform: 'ttd',
      lob: 'ai_audio',
      externalId: 'ttd-aiaudio-001',
      name: 'AI Audio - Programmatic Display Prospecting',
      status: 'active',
      budget: 39000,
      ...
      metadata: JSON.stringify({
        ...
        aovRange: [150, 300],
        targetAudience: ['audiophiles', 'commuters', 'premium device switchers'],
        aiFeatureCallouts: ['adaptive ANC', 'real-time voice enhancement', 'smart listening modes'],
        kpiType: 'CPM'
      }),
      syncedAt: now,
      createdAt: now,
    ...
    },
    {
      ...
      platform: 'dv360',
      lob: 'ai_audio',
      externalId: 'dv360-aiaudio-001',
      name: 'AI Audio - YouTube Commuter Pre-Roll',
      status: 'active',
      budget: 47000,
      startDate: daysAgo(14),
      endDate: daysFromNow(45),
      metadata: JSON.stringify({
        ...
        aovRange: [150, 300],
        targetAudience: ['daily commuters', 'music streamers', 'mobile professionals'],
        aiFeatureCallouts: ['adaptive ANC', 'context-aware assistant', 'live translation'],
        kpiType: 'CPM'
      }),
      syncedAt: now,
      createdAt: now,
    ...
    },
    {
      ...
      platform: 'amazon-dsp',
      lob: 'ai_audio',
      externalId: 'amz-aiaudio-001',
      name: 'AI Audio - Amazon DSP Native In-Market',
      status: 'active',
      budget: 32000,
      ...
      metadata: JSON.stringify({
        ...
        inventoryType: 'PMP',
        aovRange: [150, 300],
        targetAudience: ['in-market headphone shoppers', 'amazon electronics browsers'],
        aiFeatureCallouts: ['voice enhancement', 'smart EQ personalization', 'hands-free assistant'],
        kpiType: 'ROAS'
      }),
      syncedAt: now,
      createdAt: now,
    ...
    },
    {
      ...
      platform: 'ttd',
      lob: 'ai_wearables',
      externalId: 'ttd-aiwear-001',
      name: 'AI Wearables - Connected TV & Online Video Prospecting',
      status: 'active',
      budget: 52000,
      ...
      metadata: JSON.stringify({
        ...
        inventoryType: 'PMP',
        aovRange: [200, 500],
        targetAudience: ['fitness enthusiasts', 'health-conscious consumers', 'smartwatch upgraders'],
        aiFeatureCallouts: ['predictive readiness score', 'AI health coaching', 'sleep intelligence'],
        kpiType: 'CPM'
      }),
      syncedAt: now,
      createdAt: now,
    ...
    },
    {
      ...
      platform: 'dv360',
      lob: 'ai_wearables',
      externalId: 'dv360-aiwear-001',
      name: 'AI Wearables - Programmatic Display Health & Fitness',
      status: 'active',
      budget: 44000,
      startDate: daysAgo(12),
      ...
      metadata: JSON.stringify({
        ...
        inventoryType: 'open exchange',
        aovRange: [200, 500],
        targetAudience: ['active lifestyle audiences', 'fitness app users', 'biohackers'],
        aiFeatureCallouts: ['adaptive workout plans', 'recovery insights', 'AI habit coaching'],
        kpiType: 'CPC'
      }),
      syncedAt: now,
      createdAt: now,
    ...
    },
    {
      ...
      platform: 'dv360',
      lob: 'ai_home',
      externalId: 'dv360-aihome-001',
      name: 'AI Home - YouTube Smart Living Pre-Roll',
      status: 'active',
      budget: 41000,
      startDate: daysAgo(15),
      endDate: daysFromNow(41),
      metadata: JSON.stringify({
        ...
        inventoryType: 'guaranteed',
        aovRange: [100, 400],
        targetAudience: ['homeowners', 'family planners', 'smart home upgraders'],
        aiFeatureCallouts: ['context-aware routines', 'person/package detection', 'family voice memory'],
        kpiType: 'CPM'
      }),
      syncedAt: now,
      createdAt: now,
    ...
    },
    {
      ...
      platform: 'amazon-dsp',
      lob: 'ai_home',
      externalId: 'amz-aihome-001',
      name: 'AI Home - Amazon In-Market Display Retargeting',
      status: 'active',
      budget: 37000,
      startDate: daysAgo(9),
      ...
      metadata: JSON.stringify({
        ...
        inventoryType: 'PMP',
        aovRange: [100, 400],
        targetAudience: ['smart home deal seekers', 'home security researchers', 'cart abandoners'],
        aiFeatureCallouts: ['anomaly alerts', 'privacy-first controls', 'smart perimeter zones'],
        kpiType: 'ROAS'
      }),
      syncedAt: now,
      createdAt: now,
    ...
    },
    {
      ...
      platform: 'ttd',
      lob: 'ai_vision',
      externalId: 'ttd-aivision-001',
      name: 'AI Vision - Premium Display Tech Enthusiast PMP',
      status: 'active',
      budget: 48000,
      ...
      metadata: JSON.stringify({
        ...
        inventoryType: 'PMP',
        aovRange: [300, 800],
        targetAudience: ['tech innovators', 'creative professionals', 'AR early adopters'],
        aiFeatureCallouts: ['real-time scene labeling', 'hands-free visual search', 'instant object insights'],
        kpiType: 'CPM'
      }),
      syncedAt: now,
      createdAt: now,
    ...
    },
    {
      ...
      platform: 'dv360',
      lob: 'ai_vision',
      externalId: 'dv360-aivision-001',
      name: 'AI Vision - YouTube Tech Review Video',
      status: 'active',
      budget: 51000,
      startDate: daysAgo(13),
      endDate: daysFromNow(44),
      metadata: JSON.stringify({
        ...
        inventoryType: 'guaranteed',
        aovRange: [300, 800],
        targetAudience: ['tech review viewers', 'pro creator audiences', 'innovation seekers'],
        aiFeatureCallouts: ['AI autofocus framing', 'scene-aware enhancement', 'contextual overlays'],
        kpiType: 'CPM'
      }),
      syncedAt: now,
      createdAt: now,
    ...
    },
    {
      ...
      platform: 'ttd',
      lob: 'ai_productivity',
      externalId: 'ttd-aiproduct-001',
      name: 'AI Productivity - B2B Video Decision-Maker Reach',
      status: 'active',
      budget: 42000,
      startDate: daysAgo(17),
      endDate: daysFromNow(46),
      metadata: JSON.stringify({
        ...
        inventoryType: 'PMP',
        aovRange: [100, 350],
        targetAudience: ['operations managers', 'IT leaders', 'remote team leads'],
        aiFeatureCallouts: ['auto meeting summaries', 'action-item extraction', 'workflow intelligence'],
        kpiType: 'CPA'
      }),
      syncedAt: now,
      createdAt: now,
    ...
    },
    {
      ...
      platform: 'amazon-dsp',
      lob: 'ai_productivity',
      externalId: 'amz-aiproduct-001',
      name: 'AI Productivity - Amazon DSP Workday Display',
      status: 'active',
      budget: 30000,
      startDate: daysAgo(8),
      ...
      metadata: JSON.stringify({
        ...
        inventoryType: 'open exchange',
        aovRange: [100, 350],
        targetAudience: ['home office shoppers', 'business book buyers', 'work-from-home audiences'],
        aiFeatureCallouts: ['smart note capture', 'cross-device memory', 'meeting recap automation'],
        kpiType: 'ROAS'
      }),
      syncedAt: now,
      createdAt: now,
  ...
  console.log('✅ Seeded 26 AI product line campaigns across 5 LOBs');
};